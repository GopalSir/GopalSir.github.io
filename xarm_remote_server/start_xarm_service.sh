...
python3 "$CAMERA_SCRIPT" --device-a /dev/video0 --device-b /dev/video2 --port-a 8001 --port-b 8002 --width 1280 --height 720 --capture-fps 30 --fps 20 --quality 70 >> "$CAM_LOGFILE" 2>&1 &
CAMERA_PID=$!
